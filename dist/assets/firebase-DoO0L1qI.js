 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Oh(n){mt(new Ze("platform-logger",e=>new zl(e),"PRIVATE")),mt(new Ze("heartbeat",e=>new kh(e),"PRIVATE")),Pe(ws,Ao,n),Pe(ws,Ao,"esm2017"),Pe("fire-js","")}Oh("");var Po=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gt=new Qs("@firebase/firestore");function vt(){return gt.logLevel}function D(n,...e){if(gt.logLevel<=U.DEBUG){const t=e.map(Xs);gt.debug(`Firestore (${Ut}): ${n}`,...t)}}function Fe(n,...e){if(gt.logLevel<=U.ERROR){const t=e.map(Xs);gt.error(`Firestore (${Ut}): ${n}`,...t)}}function Dt(n,...e){if(gt.logLevel<=U.WARN){const t=e.map(Xs);gt.warn(`Firestore (${Ut}): ${n}`,...t)}}function Xs(n){if(typeof n=="string")return n;try{/**
* @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ar(n){if(n.code!==P.FAILED_PRECONDITION||n.message!==Gh)throw n;D("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class be{constructor(e){this.value=e}static empty(){return new be({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let r=0;r<e.length-1;++r)if(t=(t.mapValue.fields||{})[e.get(r)],!ds(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=cn(t)}setAll(e){let t=Te.emptyPath(),r={},s=[];e.forEach((a,c)=>{if(!t.isImmediateParentOf(c)){const h=this.getFieldsMap(t);this.applyChanges(h,r,s),r={},s=[],t=c.popLast()}a?r[c.lastSegment()]=cn(a):s.push(c.lastSegment())});const o=this.getFieldsMap(t);this.applyChanges(o,r,s)}delete(e){const t=this.field(e.popLast());ds(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return De(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let r=0;r<e.length;++r){let s=t.mapValue.fields[e.get(r)];ds(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},t.mapValue.fields[e.get(r)]=s),t=s}return t.mapValue.fields}applyChanges(e,t,r){wn(t,(s,o)=>e[s]=o);for(const s of r)delete e[s]}clone(){return new be(cn(this.value))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hr{constructor(e,t){this.position=e,this.inclusive=t}}function jo(n,e,t){let r=0;for(let s=0;s<n.position.length;s++){const o=e[s],a=n.position[s];if(o.field.isKeyField()?r=L.comparator(L.fromName(a.referenceValue),t.key):r=Vt(a,t.data.field(o.field)),o.dir==="desc"&&(r*=-1),r!==0)break}return r}function zo(n,e){if(n===null)return e===null;if(e===null||n.inclusive!==e.inclusive||n.position.length!==e.position.length)return!1;for(let t=0;t<n.position.length;t++)if(!De(n.position[t],e.position[t]))return!1;return!0}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Af{constructor(){this.Zi=!1,this.Xi=!1,this.es=100,this.ts=function(){return gl()?8:Wh(Ce())>0?6:4}()}initialize(e,t){this.ns=e,this.indexManager=t,this.Zi=!0}getDocumentsMatchingQuery(e,t,r,s){const o={result:null};return this.rs(e,t).next(a=>{o.result=a}).next(()=>{if(!o.result)return this.ss(e,t,s,r).next(a=>{o.result=a})}).next(()=>{if(o.result)return;const a=new wf;return this._s(e,t,a).next(c=>{if(o.result=c,this.Xi)return this.us(e,t,a,c.size)})}).next(()=>o.result)}us(e,t,r,s){return r.documentReadCount<this.es?(vt()<=U.DEBUG&&D("QueryEngine","SDK will not create cache indexes for query:",wt(t),"since it only creates cache indexes for collection contains","more than or equal to",this.es,"documents"),C.resolve()):(vt()<=U.DEBUG&&D("QueryEngine","Query:",wt(t),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.ts*s?(vt()<=U.DEBUG&&D("QueryEngine","The SDK decides to create cache indexes for query:",wt(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,ke(t))):C.resolve())}rs(e,t){if(Ko(t))return C.resolve(null);let r=ke(t);return this.indexManager.getIndexType(e,r).next(s=>s===0?null:(t.limit!==null&&s===1&&(t=Ls(t,null,"F"),r=ke(t)),this.indexManager.getDocumentsMatchingTarget(e,r).next(o=>{const a=z(...o);return this.ns.getDocuments(e,a).next(c=>this.indexManager.getMinOffset(e,r).next(h=>{const f=this.cs(t,c);return this.ls(t,f,a,h.readTime)?this.rs(e,Ls(t,null,"F")):this.hs(e,f,t,h)}))})))}ss(e,t,r,s){return Ko(t)||s.isEqual(M.min())?C.resolve(null):this.ns.getDocuments(e,r).next(o=>{const a=this.cs(t,o);return this.ls(t,a,r,s)?C.resolve(null):(vt()<=U.DEBUG&&D("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),wt(t)),this.hs(e,a,t,zh(s,gn)).next(c=>c))})}cs(e,t){let r=new ie(gu(e));return t.forEach((s,o)=>{kr(e,o)&&(r=r.add(o))}),r}ls(e,t,r,s){if(e.limit===null)return!1;if(r.size!==t.size)return!0;const o=e.limitType==="F"?t.last():t.first();return!!o&&(o.hasPendingWrites||o.version.compareTo(s)>0)}_s(e,t,r){return vt()<=U.DEBUG&&D("QueryEngine","Using full collection scan to execute query:",wt(t)),this.ns.getDocumentsMatchingQuery(e,t,et.min(),r)}hs(e,t,r,s){return this.ns.getDocumentsMatchingQuery(e,r,s).next(o=>(t.forEach(a=>{o=o.insert(a.key,a)}),o))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const aa="ConnectivityMonitor";class ua{constructor(){this.Io=()=>this.Eo(),this.Ao=()=>this.Ro(),this.Vo=[],this.mo()}To(e){this.Vo.push(e)}shutdown(){window.removeEventListener("online",this.Io),window.removeEventListener("offline",this.Ao)}mo(){window.addEventListener("online",this.Io),window.addEventListener("offline",this.Ao)}Eo(){D(aa,"Network connectivity changed: AVAILABLE");for(const e of this.Vo)e(0)}Ro(){D(aa,"Network connectivity changed: UNAVAILABLE");for(const e of this.Vo)e(1)}static D(){return typeof window<"u"&&window.addEventListener!==void 0&&window.removeEventListener!==void 0}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ps="RestConnection",Of={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery"};class Lf{get fo(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",r=encodeURIComponent(this.databaseId.projectId),s=encodeURIComponent(this.databaseId.database);this.po=t+"://"+e.host,this.yo=`projects/${r}/databases/${s}`,this.wo=this.databaseId.database===lr?`project_id=${r}`:`project_id=${r}&database_id=${s}`}So(e,t,r,s,o){const a=$s(),c=this.bo(e,t.toUriEncodedString());D(ps,`Sending RPC '${e}' ${a}:`,c,r);const h={"google-cloud-resource-prefix":this.yo,"x-goog-request-params":this.wo};return this.Do(h,s,o),this.vo(e,c,h,r).then(f=>(D(ps,`Received RPC '${e}' ${a}: `,f),f),f=>{throw Dt(ps,`RPC '${e}' ${a} failed with error: `,f,"url: ",c,"request:",r),f})}Co(e,t,r,s,o,a){return this.So(e,t,r,s,o)}Do(e,t,r){e["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+Ut}(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((s,o)=>e[o]=s),r&&r.headers.forEach((s,o)=>e[o]=s)}bo(e,t){const r=Of[e];return`${this.po}/v1/${t}:${r}`}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const me="WebChannelConnection";class xf extends Lf{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}vo(e,t,r,s){const o=$s();return new Promise((a,c)=>{const h=new Xa;h.setWithCredentials(!0),h.listenOnce(Ja.COMPLETE,()=>{try{switch(h.getLastErrorCode()){case tr.NO_ERROR:const _=h.getResponseJson();D(me,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(_)),a(_);break;case tr.TIMEOUT:D(me,`RPC '${e}' ${o} timed out`),c(new V(P.DEADLINE_EXCEEDED,"Request time out"));break;case tr.HTTP_ERROR:const w=h.getStatus();if(D(me,`RPC '${e}' ${o} failed with status:`,w,"response text:",h.getResponseText()),w>0){let R=h.getResponseJson();Array.isArray(R)&&(R=R[0]);const S=R==null?void 0:R.error;if(S&&S.status&&S.message){const N=function(k){const G=k.toLowerCase().replace(/_/g,"-");return Object.values(P).indexOf(G)>=0?G:P.UNKNOWN}(S.status);c(new V(N,S.message))}else c(new V(P.UNKNOWN,"Server responded with status "+h.getStatus()))}else c(new V(P.UNAVAILABLE,"Connection failed."));break;default:x()}}finally{D(me,`RPC '${e}' ${o} completed.`)}});const f=JSON.stringify(s);D(me,`RPC '${e}' ${o} sending request:`,s),h.send(t,"POST",f,r,15)})}Wo(e,t,r){const s=$s(),o=[this.po,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=eu(),c=Za(),h={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},f=this.longPollingOptions.timeoutSeconds;f!==void 0&&(h.longPollingTimeout=Math.round(1e3*f)),this.useFetchStreams&&(h.useFetchStreams=!0),this.Do(h.initMessageHeaders,t,r),h.encodeInitMessageHeaders=!0;const _=o.join("");D(me,`Creating RPC '${e}' stream ${s}: ${_}`,h);const w=a.createWebChannel(_,h);let R=!1,S=!1;const N=new Mf({Fo:k=>{S?D(me,`Not sending because RPC '${e}' stream ${s} is closed:`,k):(R||(D(me,`Opening RPC '${e}' stream ${s} transport.`),w.open(),R=!0),D(me,`RPC '${e}' stream ${s} sending:`,k),w.send(k))},Mo:()=>w.close()}),O=(k,G,Q)=>{k.listen(G,F=>{try{Q(F)}catch(j){setTimeout(()=>{throw j},0)}})};return O(w,on.EventType.OPEN,()=>{S||(D(me,`RPC '${e}' stream ${s} transport opened.`),N.Qo())}),O(w,on.EventType.CLOSE,()=>{S||(S=!0,D(me,`RPC '${e}' stream ${s} transport closed`),N.Uo())}),O(w,on.EventType.ERROR,k=>{S||(S=!0,Dt(me,`RPC '${e}' stream ${s} transport errored:`,k),N.Uo(new V(P.UNAVAILABLE,"The operation could not be completed")))}),O(w,on.EventType.MESSAGE,k=>{var G;if(!S){const Q=k.data[0];Y(!!Q);const F=Q,j=(F==null?void 0:F.error)||((G=F[0])===null||G===void 0?void 0:G.error);if(j){D(me,`RPC '${e}' stream ${s} received error:`,j);const ae=j.status;let X=function(g){const y=re[g];if(y!==void 0)return Au(y)}(ae),E=j.message;X===void 0&&(X=P.INTERNAL,E="Unknown error status: "+ae+" with message "+j.message),S=!0,N.Uo(new V(X,E)),w.close()}else D(me,`RPC '${e}' stream ${s} received:`,Q),N.Ko(Q)}}),O(c,Ya.STAT_EVENT,k=>{k.stat===Cs.PROXY?D(me,`RPC '${e}' stream ${s} detected buffering proxy`):k.stat===Cs.NOPROXY&&D(me,`RPC '${e}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{N.$o()},0),N}}function ms(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kp{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new V(P.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new V(P.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return B(this._lat,e._lat)||B(this._long,e._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ys(n,e,t){return`firebase:${n}:${e}:${t}`}class kt{constructor(e,t,r){this.persistence=e,this.auth=t,this.userKey=r;const{config:s,name:o}=this.auth;this.fullUserKey=ys(this.userKey,s.apiKey,o),this.fullPersistenceKey=ys("persistence",s.apiKey,o),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?We._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,r="authUser"){if(!t.length)return new kt(dt(Pa),e,r);const s=(await Promise.all(t.map(async f=>{if(await f._isAvailable())return f}))).filter(f=>f);let o=s[0]||dt(Pa);const a=ys(r,e.config.apiKey,e.name);let c=null;for(const f of t)try{const _=await f._get(a);if(_){const w=We._fromJSON(e,_);f!==o&&(c=w),o=f;break}}catch{}const h=s.filter(f=>f._shouldAllowMigration);return!o._shouldAllowMigration||!h.length?new kt(o,e,r):(o=h[0],c&&await o._set(a,c.toJSON()),await Promise.all(t.map(async f=>{if(f!==o)try{await f._remove(a)}catch{}})),new kt(o,e,r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ka(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(lm(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(am(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(dm(e))return"Blackberry";if(fm(e))return"Webos";if(um(e))return"Safari";if((e.includes("chrome/")||cm(e))&&!e.includes("edge/"))return"Chrome";if(hm(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=n.match(t);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function am(n=Ce()){return/firefox\//i.test(n)}function um(n=Ce()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function cm(n=Ce()){return/crios\//i.test(n)}function lm(n=Ce()){return/iemobile/i.test(n)}function hm(n=Ce()){return/android/i.test(n)}function dm(n=Ce()){return/blackberry/i.test(n)}function fm(n=Ce()){return/webos/i.test(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mc(n,e=[]){let t;switch(n){case"Browser":t=ka(Ce());break;case"Worker":t=`${ka(Ce())}-${n}`;break;default:t=n}const r=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${vn}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lm(n,e,t){let r=1,s=null,o=null,a=!1,c=0;function h(){return c===2}let f=!1;function _(...k){f||(f=!0,e.apply(null,k))}function w(k){s=setTimeout(()=>{s=null,n(S,h())},k)}function R(){o&&clearTimeout(o)}function S(k,...G){if(f){R();return}if(k){R(),_.call(null,k,...G);return}if(h()||a){R(),_.call(null,k,...G);return}r<64&&(r*=2);let F;c===1?(c=2,F=0):F=(r+Math.random())*1e3,w(F)}let N=!1;function O(k){N||(N=!0,R(),!f&&(s!==null?(k||(c=2),clearTimeout(s),w(0)):k||(c=1)))}return w(0),o=setTimeout(()=>{a=!0,O(!0)},t),O}function Mm(n){n(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wm="storage";function Xm(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),r=n.getProvider("auth-internal"),s=n.getProvider("app-check-internal");return new Qm(t,r,s,e,vn)}function Jm(){mt(new Ze(Wm,Xm,"PUBLIC").setMultipleInstances(!0)),Pe(xa,Ua,""),Pe(xa,Ua,"esm2017")}Jm();const Ym={projectId:"d4studio-84b9d",apiKey:"AIzaSyAxRjt8OUhAMmikv9WeWCY9hW2-DPoCFgc",storageBucket:"gs://d4studio-84b9d.firebasestorage.app"},Zm=Ka(Ym),eg=Sp(Zm);async function ng(n){let e=[];return(await $p(Cp(eg,n))).forEach(r=>{e.push({id:r.id,...r.data()})}),e}export{ng as g};
